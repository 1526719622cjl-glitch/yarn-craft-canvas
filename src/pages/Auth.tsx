      ...
      >
        <div className="glass-card p-8">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-display font-semibold text-foreground">Yarn Clues</h1>
            <p className="text-muted-foreground text-sm mt-1">线·索 Design Suite</p>
          </div>
          ...
          <Tabs defaultValue="signin" className="w-full">
            ...
            <TabsContent value="signin">
              <form onSubmit={handleSignIn} className="space-y-4">
                ...
                <Button 
                  type="submit" 
                  className="w-full h-12 rounded-2xl soft-press"
                  disabled={isLoading}
                >
                  {isLoading ? (
            ...
            <TabsContent value="signup">
              <form onSubmit={handleSignUp} className="space-y-4">
                <div className="space-y-2">
                  <Label htmlFor="signup-name" className="text-sm text-muted-foreground">Display Name (Optional)</Label>
                  <div className="relative">
